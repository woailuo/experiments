...
struct Poker * Poker_create_1(char *name, int num);
struct Poker * Poker_create_2(char *name, int num);
void Poker_print_3(struct Poker *pn);
void Poker_print_4(struct Poker *pn);
void Poker_destroy_5(struct Poker *pn);
void Poker_destroy_6(struct Poker *pn);
int main_0(int argc, char *argv[]) {
  struct Poker *fst;struct Poker *sec;char *pname[] = { "Diamond", "Spade", "Heart", "Club" };
  printf("Do you have time to play poker? 1 is Yes, to start\n");
  int play;
  scanf("%d", &play);
  __CPROVER_assume(play > 0);
  int __CPAchecker_TMP_0;int __CPAchecker_TMP_1;
  __CPAchecker_TMP_1 = rand();
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = rand();
  __CPAchecker_TMP_0 = Poker_create_1(pname[__CPAchecker_TMP_1 % 4], (__CPAchecker_TMP_2 % 13) + 1);
  fst = __CPAchecker_TMP_0;int __CPAchecker_TMP_3;
  __CPAchecker_TMP_3 = rand();
  int __CPAchecker_TMP_4;
  __CPAchecker_TMP_4 = rand();
  struct Poker *__CPAchecker_TMP_5;
  __CPAchecker_TMP_5 = Poker_create_2(pname[__CPAchecker_TMP_3 % 4], (__CPAchecker_TMP_4 % 13) + 1);
  __CPROVER_assume(!(__CPAchecker_TMP_5 == 0));
  __CPROVER_assume(sec == 0);
  __CPAchecker_TMP_0 = 0;
  __CPROVER_assume(!(fst == 0));
  Poker_print_3(fst);
  Poker_print_4(sec);
  Poker_destroy_5(fst);
  Poker_destroy_6(sec);
...
void Poker_destroy_6(struct Poker *pn) {
  ...
  __assert_fail("pn != ((void *)0)", "tf/poker_rw.c", 38, "__PRETTY_FUNCTION__");
}
