...
STATE USEFIRST ARG2_379_1 :
    MATCH "extern int *__errno_location (void) __attribute__ ((__nothrow__)) __attribute__ ((__const__));" -> GOTO ARG2_380_1;
...
STATE USEFIRST ARG2_430_1 :
    MATCH "int Num = 1;" -> GOTO ARG2_431_1;
STATE USEFIRST ARG2_431_1 :
    MATCH "struct Address {\n    int id;\n    int set;\n    char name[512];\n    char email[512];\n};" -> GOTO ARG2_432_1;
STATE USEFIRST ARG2_432_1 :
    MATCH "struct Database {\n    struct Address rows[100];\n};" -> GOTO ARG2_433_1;
STATE USEFIRST ARG2_433_1 :
    MATCH "struct Connection {\n    FILE *file;\n    struct Database *db;\n};" -> GOTO ARG2_434_1;
STATE USEFIRST ARG2_434_1 :
    MATCH "void die(const char *message)" -> GOTO ARG2_435_1;
STATE USEFIRST ARG2_435_1 :
    MATCH "void Address_print(struct Address *addr)" -> GOTO ARG2_436_1;
STATE USEFIRST ARG2_436_1 :
    MATCH "void Database_load(struct Connection *conn)" -> GOTO ARG2_437_1;
STATE USEFIRST ARG2_437_1 :
    MATCH "struct Connection *Database_open(const char *filename, char mode)" -> GOTO ARG2_438_1;
STATE USEFIRST ARG2_438_1 :
    MATCH "void Database_close(struct Connection *conn)" -> GOTO ARG2_439_1;
STATE USEFIRST ARG2_439_1 :
    MATCH "void Database_write(struct Connection *conn)" -> GOTO ARG2_440_1;
STATE USEFIRST ARG2_440_1 :
    MATCH "void Database_create(struct Connection *conn)" -> GOTO ARG2_441_1;
STATE USEFIRST ARG2_441_1 :
    MATCH "void Database_set(struct Connection *conn, int id, const char *name, const char *email)" -> GOTO ARG2_442_1;
STATE USEFIRST ARG2_442_1 :
    MATCH "void Database_get(struct Connection *conn, int id)" -> GOTO ARG2_443_1;
STATE USEFIRST ARG2_443_1 :
    MATCH "void Database_delete(struct Connection *conn, int id)" -> GOTO ARG2_444_1;
STATE USEFIRST ARG2_444_1 :
    MATCH "void Database_list(struct Connection *conn)" -> GOTO ARG2_445_1;
STATE USEFIRST ARG2_445_1 :
    MATCH "int main(int argc, char *argv[])" -> GOTO ARG2_446_1;
STATE USEFIRST ARG2_446_1 :
    MATCH "" -> ASSUME {Num = 1; }GOTO ARG2;
    TRUE -> STOP;

STATE USEFIRST ARG2 :
    MATCH "[!(argc < 3)]" -> GOTO ARG4;
    TRUE -> STOP;

STATE USEFIRST ARG4 :
    MATCH "char *filename = argv[1];" -> GOTO ARG16_1_2;
STATE USEFIRST ARG16_0_2 :
    MATCH "char *filename = argv[1];" -> GOTO ARG16_1_2;
STATE USEFIRST ARG16_1_2 :
    MATCH "char action = argv[2][0];" -> GOTO ARG16_2_2;
STATE USEFIRST ARG16_2_2 :
    MATCH "struct Connection *conn = Database_open(filename, action);" -> ASSUME {filename = 13; action = 9; }GOTO ARG16;
    TRUE -> STOP;

STATE USEFIRST ARG16 :
    MATCH "struct Connection *conn = Database_open(filename, action);" -> ASSUME {filename = 13; mode = 9; }GOTO ARG17;
    TRUE -> STOP;
...
STATE USEFIRST ARG18 :
    MATCH "struct Connection *conn = malloc(sizeof(struct Connection));" -> GOTO ARG19;
    TRUE -> STOP;

STATE USEFIRST ARG19 :
    MATCH "struct Connection *conn = malloc(sizeof(struct Connection));" -> ASSUME {conn = 0.5; }GOTO ARG20;
    TRUE -> STOP;

STATE USEFIRST ARG20 :
    MATCH "Num = Num - 1 ;" -> ASSUME {Num = 0; }GOTO ARG21;
    TRUE -> STOP;

STATE USEFIRST ARG21 :
    MATCH "[Num >= 0]" -> GOTO ARG22;
    TRUE -> STOP;

STATE USEFIRST ARG22 :
    MATCH "(void) (0)" -> GOTO ARG24;
    TRUE -> STOP;

STATE USEFIRST ARG24 :
    MATCH "[!(conn == 0)]" -> GOTO ARG26;
    TRUE -> STOP;

STATE USEFIRST ARG26 :
    MATCH "conn->db = malloc(sizeof(struct Database));" -> ASSUME {conn->db = 8.5; }GOTO ARG38;
    TRUE -> STOP;

STATE USEFIRST ARG38 :
    MATCH "Num = Num - 1 ;" -> ASSUME {Num = -1; }GOTO ARG39;
    TRUE -> STOP;

STATE USEFIRST ARG39 :
    MATCH "[!(Num >= 0)]" -> GOTO ARG41;
    TRUE -> STOP;

STATE USEFIRST ARG41 :
    MATCH "__assert_fail (\"Num >=0\", \"tf/database.c\", 63, __PRETTY_FUNCTION__)" -> ERROR;
    TRUE -> STOP;
