...
int main_0(int argc, char *argv[]) {
  ...
  __CPAchecker_TMP_0 = rand();
  int __CPAchecker_TMP_1;
  __CPAchecker_TMP_1 = rand();
  fst = Poker_create_1(pname[__CPAchecker_TMP_0 % 4], (__CPAchecker_TMP_1 % 13) + 1);
  int __CPAchecker_TMP_2;
  __CPAchecker_TMP_2 = rand();
  int __CPAchecker_TMP_3;
  __CPAchecker_TMP_3 = rand();
  sec = Poker_create_2(pname[__CPAchecker_TMP_2 % 4], (__CPAchecker_TMP_3 % 13) + 1);
}
...
struct Poker * Poker_create_2(char *name, int num) {
  ...
  __assert_fail("Num >= 0", "tf/poker.c", 22, "__PRETTY_FUNCTION__");
}
