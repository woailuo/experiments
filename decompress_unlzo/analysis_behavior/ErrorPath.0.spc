...
STATE USEFIRST ARG11_192_1 :
    MATCH "int Num = 2;" -> GOTO ARG11_193_1;
...
STATE USEFIRST ARG11_195_1 :
    MATCH "void decompress_unlzo()" -> GOTO ARG11_196_1;
...
STATE USEFIRST ARG11 :
    MATCH "decompress_unlzo();" -> GOTO ARG12;
    TRUE -> STOP;
...
STATE USEFIRST ARG29 :
    MATCH "" -> GOTO ARG30_1_4;
STATE USEFIRST ARG30_0_4 :
    MATCH "" -> GOTO ARG30_1_4;
STATE USEFIRST ARG30_1_4 :
    MATCH "Num = Num - 1;" -> GOTO ARG30;
    TRUE -> STOP;

STATE USEFIRST ARG30 :
    MATCH "[Num >= 0]" -> GOTO ARG31;
    TRUE -> STOP;

STATE USEFIRST ARG31 :
    MATCH "(void) (0)" -> GOTO ARG33;
    TRUE -> STOP;
...
STATE USEFIRST ARG38 :
    MATCH "" -> GOTO ARG39_1_5;
STATE USEFIRST ARG39_0_5 :
    MATCH "" -> GOTO ARG39_1_5;
STATE USEFIRST ARG39_1_5 :
    MATCH "Num = Num - 1;" -> GOTO ARG39;
    TRUE -> STOP;
...
STATE USEFIRST ARG41 :
    MATCH "__assert_fail (\"Num >= 0\", \"nf/behavior.c\", 7, __PRETTY_FUNCTION__)" -> ERROR;
    TRUE -> STOP;
