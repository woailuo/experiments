...
STATE USEFIRST ARG2_191_1 :
    MATCH "int Num = 1 ;" -> GOTO ARG2_192_1;
...
STATE USEFIRST ARG2_194_1 :
    MATCH "void gen_init_cpio()" -> GOTO ARG2_195_1;
...
STATE USEFIRST ARG6 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 0; }GOTO ARG7;
    TRUE -> STOP;
...
STATE USEFIRST ARG14 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = -1; }GOTO ARG15;
    TRUE -> STOP;

STATE USEFIRST ARG15 :
    MATCH "[!(Num >= 0)]" -> GOTO ARG17;
    TRUE -> STOP;
