...
STATE USEFIRST ARG2_470_1 :
    MATCH "int Num = 2;" -> GOTO ARG2_471_1;
...
STATE USEFIRST ARG2_479_1 :
    MATCH "char *pname[] = {\"Diamond\",\"Spade\",\"Heart\",\"Club\"};" -> GOTO ARG2;
    TRUE -> STOP;
...
STATE USEFIRST ARG6 :
    MATCH "fst = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG8;
    TRUE -> STOP;

STATE USEFIRST ARG8 :
    MATCH "fst = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG9;
    TRUE -> STOP;

STATE USEFIRST ARG9 :
    MATCH "fst = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG10;
    TRUE -> STOP;

STATE USEFIRST ARG10 :
    MATCH "fst = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG11;
    TRUE -> STOP;

STATE USEFIRST ARG11 :
    MATCH "fst = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG12;
    TRUE -> STOP;

STATE USEFIRST ARG12 :
    MATCH "" -> GOTO ARG13_1_2;
STATE USEFIRST ARG13_0_2 :
    MATCH "" -> GOTO ARG13_1_2;
STATE USEFIRST ARG13_1_2 :
    MATCH "struct Poker *pn = malloc(sizeof(struct Poker));" -> GOTO ARG13;
    TRUE -> STOP;
...
STATE USEFIRST ARG18 :
    MATCH "[pn != ((void *)0)]" -> GOTO ARG19;
    TRUE -> STOP;

STATE USEFIRST ARG19 :
    MATCH "(void) (0)" -> GOTO ARG21;
    TRUE -> STOP;

STATE USEFIRST ARG21 :
    MATCH "pn->name = strdup(name);" -> GOTO ARG22;
    TRUE -> STOP;
...
STATE USEFIRST ARG26 :
    MATCH "pn->num = num;" -> GOTO ARG27_1_3;
STATE USEFIRST ARG27_0_3 :
    MATCH "pn->num = num;" -> GOTO ARG27_1_3;
STATE USEFIRST ARG27_1_3 :
    MATCH "return pn;" -> GOTO ARG27;
    TRUE -> STOP;
...
STATE USEFIRST ARG28 :
    MATCH "sec = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG29;
    TRUE -> STOP;

STATE USEFIRST ARG29 :
    MATCH "sec = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG30;
    TRUE -> STOP;

STATE USEFIRST ARG30 :
    MATCH "sec = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG31;
    TRUE -> STOP;

STATE USEFIRST ARG31 :
    MATCH "sec = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG32;
    TRUE -> STOP;

STATE USEFIRST ARG32 :
    MATCH "sec = Poker_create(pname[rand()%4], (rand()%13) + 1);" -> GOTO ARG33;
    TRUE -> STOP;

STATE USEFIRST ARG33 :
    MATCH "" -> GOTO ARG34_1_4;
STATE USEFIRST ARG34_0_4 :
    MATCH "" -> GOTO ARG34_1_4;
STATE USEFIRST ARG34_1_4 :
    MATCH "struct Poker *pn = malloc(sizeof(struct Poker));" -> GOTO ARG34;
    TRUE -> STOP;

STATE USEFIRST ARG34 :
    MATCH "struct Poker *pn = malloc(sizeof(struct Poker));" -> GOTO ARG35;
    TRUE -> STOP;

STATE USEFIRST ARG35 :
    MATCH "Num = Num -1 ;" -> GOTO ARG36;
    TRUE -> STOP;

STATE USEFIRST ARG36 :
    MATCH "[!(Num >= 0)]" -> GOTO ARG38;
    TRUE -> STOP;

STATE USEFIRST ARG38 :
    MATCH "__assert_fail (\"Num >= 0\", \"tf/poker.c\", 22, __PRETTY_FUNCTION__)" -> ERROR;
    TRUE -> STOP;
