...
STATE USEFIRST ARG22_191_1 :
    MATCH "int Num = 6 ;" -> GOTO ARG22_192_1;
...
STATE USEFIRST ARG22_194_1 :
    MATCH "void linklist()" -> GOTO ARG22_195_1;
STATE USEFIRST ARG22_195_1 :
    MATCH "int main()" -> GOTO ARG22_196_1;
STATE USEFIRST ARG22_196_1 :
    MATCH "" -> ASSUME {Num = 6; } GOTO ARG22;
    TRUE -> STOP;

STATE USEFIRST ARG22 :
    MATCH "linklist();" -> GOTO ARG23;
    TRUE -> STOP;
...
STATE USEFIRST ARG26 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 5; } GOTO ARG27;
    TRUE -> STOP;
...
STATE USEFIRST ARG176 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 4; } GOTO ARG177;
    TRUE -> STOP;
...
STATE USEFIRST ARG186 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 3; } GOTO ARG187;
    TRUE -> STOP;

STATE USEFIRST ARG187 :
    MATCH "[Num >= 0]" -> GOTO ARG188;
    TRUE -> STOP;

STATE USEFIRST ARG188 :
    MATCH "(void) (0)" -> GOTO ARG190;
    TRUE -> STOP;
...
STATE USEFIRST ARG196 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 2; } GOTO ARG197;
    TRUE -> STOP;

STATE USEFIRST ARG197 :
    MATCH "[Num >= 0]" -> GOTO ARG198;
    TRUE -> STOP;

STATE USEFIRST ARG198 :
    MATCH "(void) (0)" -> GOTO ARG200;
    TRUE -> STOP;
...
STATE USEFIRST ARG206 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 1; } GOTO ARG207;
    TRUE -> STOP;

STATE USEFIRST ARG207 :
    MATCH "[Num >= 0]" -> GOTO ARG208;
    TRUE -> STOP;

STATE USEFIRST ARG208 :
    MATCH "(void) (0)" -> GOTO ARG210;
    TRUE -> STOP;
...
STATE USEFIRST ARG216 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = 0; } GOTO ARG217;
    TRUE -> STOP;

STATE USEFIRST ARG217 :
    MATCH "[Num >= 0]" -> GOTO ARG218;
    TRUE -> STOP;

STATE USEFIRST ARG218 :
    MATCH "(void) (0)" -> GOTO ARG220;
    TRUE -> STOP;
...
STATE USEFIRST ARG226 :
    MATCH "Num = Num - 1;" -> ASSUME {Num = -1; } GOTO ARG227;
    TRUE -> STOP;

STATE USEFIRST ARG227 :
    MATCH "[!(Num >= 0)]" -> GOTO ARG229;
    TRUE -> STOP;
