...
STATE USEFIRST ARG11_192_1 :
    MATCH "int Num = 4;" -> GOTO ARG11_193_1;
...
STATE USEFIRST ARG11_195_1 :
    MATCH "void poker()" -> GOTO ARG11_196_1;
...
STATE USEFIRST ARG11 :
    MATCH "poker();" -> GOTO ARG12;
    TRUE -> STOP;

STATE USEFIRST ARG12 :
    MATCH "" -> GOTO ARG44_1_2;
STATE USEFIRST ARG44_0_2 :
    MATCH "" -> GOTO ARG44_1_2;
STATE USEFIRST ARG44_1_2 :
    MATCH "l1:\n  M();" -> GOTO ARG44;
    TRUE -> STOP;
...
STATE USEFIRST ARG52 :
    MATCH "" -> GOTO ARG53_1_4;
STATE USEFIRST ARG53_0_4 :
    MATCH "" -> GOTO ARG53_1_4;
STATE USEFIRST ARG53_1_4 :
    MATCH "Num = Num - 1;" -> GOTO ARG53;
    TRUE -> STOP;

STATE USEFIRST ARG53 :
    MATCH "[Num >= 0]" -> GOTO ARG54;
    TRUE -> STOP;

STATE USEFIRST ARG54 :
    MATCH "(void) (0)" -> GOTO ARG56;
    TRUE -> STOP;
...
STATE USEFIRST ARG61 :
    MATCH "" -> GOTO ARG62_1_5;
STATE USEFIRST ARG62_0_5 :
    MATCH "" -> GOTO ARG62_1_5;
STATE USEFIRST ARG62_1_5 :
    MATCH "Num = Num - 1;" -> GOTO ARG62;
    TRUE -> STOP;

STATE USEFIRST ARG62 :
    MATCH "[Num >= 0]" -> GOTO ARG63;
    TRUE -> STOP;

STATE USEFIRST ARG63 :
    MATCH "(void) (0)" -> GOTO ARG65;
    TRUE -> STOP;
...
STATE USEFIRST ARG68 :
    MATCH "" -> GOTO ARG69_1_6;
STATE USEFIRST ARG69_0_6 :
    MATCH "" -> GOTO ARG69_1_6;
STATE USEFIRST ARG69_1_6 :
    MATCH "Num = Num - 1;" -> GOTO ARG69;
    TRUE -> STOP;

STATE USEFIRST ARG69 :
    MATCH "[Num >= 0]" -> GOTO ARG70;
    TRUE -> STOP;

STATE USEFIRST ARG70 :
    MATCH "(void) (0)" -> GOTO ARG72;
    TRUE -> STOP;
...
STATE USEFIRST ARG77 :
    MATCH "" -> GOTO ARG78_1_7;
STATE USEFIRST ARG78_0_7 :
    MATCH "" -> GOTO ARG78_1_7;
STATE USEFIRST ARG78_1_7 :
    MATCH "Num = Num - 1;" -> GOTO ARG78;
    TRUE -> STOP;

STATE USEFIRST ARG78 :
    MATCH "[!(Num >= 0)]" -> GOTO ARG80;
    TRUE -> STOP;

STATE USEFIRST ARG80 :
    MATCH "__assert_fail (\"Num >= 0\", \"tf/behavior.c\", 9, __PRETTY_FUNCTION__)" -> ERROR;
    TRUE -> STOP;
