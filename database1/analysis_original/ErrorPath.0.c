...
int main();
int main_0();
void CreateListTail_1(LinkList *L, int n);
Status  ListTraverse_2(LinkList L);
Status  visit_3(ElemType c);
Status  visit_4(ElemType c);
Status  ClearList_5(LinkList *L);
int ListLength_6(LinkList L);
void CreateListTail_7(LinkList *L, int n);
Status  ListTraverse_8(LinkList L);
Status  visit_9(ElemType c);
Status  visit_10(ElemType c);
Status  ClearList_11(LinkList *L);
int ListLength_12(LinkList L);
void CreateListTail_13(LinkList *L, int n);
int main_0() {
  LinkList L;Status i;
  CreateListTail_1(&L, 2);
  printf("整体创建L的元素(头插法)：");
  ListTraverse_2(L);
  i = ClearList_5(&L);
  int __CPAchecker_TMP_0;
  __CPAchecker_TMP_0 = ListLength_6(L);
  printf("\n删除L后：ListLength(L)=%d\n", __CPAchecker_TMP_0);
  CreateListTail_7(&L, 2);
  printf("整体创建L的元素(头插法)：");
  ListTraverse_8(L);
  i = ClearList_11(&L);
  __CPAchecker_TMP_0 = ListLength_12(L);
  printf("\n删除L后：ListLength(L)=%d\n", __CPAchecker_TMP_0);
  CreateListTail_13(&L, 2);
}

void CreateListTail_1(LinkList *L, int n) {
  LinkList p;LinkList r;int i;time_t __CPAchecker_TMP_0;
  __CPAchecker_TMP_0 = time(0);
  srand(__CPAchecker_TMP_0);
  *L = malloc(8);
  Num = Num - 1;
  ...
  p->data = (__CPAchecker_TMP_3 % 100) + 1;r->next = p;r = p;i = i + 1;
  __CPROVER_assume(i < n);
  p = malloc(8);
  Num = Num - 1;
  __CPROVER_assume(Num >= 0);
...
Status  ClearList_5(LinkList *L) {
  LinkList p;LinkList q;p = (*L)->next;
  __CPROVER_assume(!(p == 0));
  q = p->next;
  free(p);
  Num = Num + 1;p = q;
...
void CreateListTail_13(LinkList *L, int n) {
  ...
  *L = malloc(8);
  ...
  __assert_fail("Num >= 0", "tf/linklist2.c", 230, "__PRETTY_FUNCTION__");
}
