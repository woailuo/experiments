...
struct Person * Person_create_1(char *name, int age, int height, int weight);
struct Person * Person_create_2(char *name, int age, int height, int weight);
int main_0(int argc, char *argv[]) {
  struct Person *joe;
  joe = Person_create_1("Joe Alex", 32, 64, 140);
  struct Person *frank;
  frank = Person_create_2("Frank Blank", 20, 72, 180);
}
...
struct Person * Person_create_1(char *name, int age, int height, int weight) {
  ...
  (void)0;
  __CPROVER_assume(who != ((void *)0));
  (void)0;
  who->name = strdup(name);
  Num = Num - 1;
  __CPROVER_assume(Num >= 0);
  (void)0;
  who->age = age;who->height = height;who->weight = weight;return who;
}
...
struct Person * Person_create_2(char *name, int age, int height, int weight) {
  ...
  __assert_fail("Num >= 0", "tf/person.c", 23, "__PRETTY_FUNCTION__");
}
